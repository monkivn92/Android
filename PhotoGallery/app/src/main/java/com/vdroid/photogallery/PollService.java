...
public class PollService extends IntentService
{
    ...
    public static final String ACTION_SHOW_NOTIFICATION =   "com.vdroid.photogallery.SHOW_NOTIFICATION";
    public static final String PERM_PRIVATE = "com.vdroid.photogallery.PRIVATE";
